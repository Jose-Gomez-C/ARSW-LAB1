...
public class MultiThreads extends Thread{
	...
	public MultiThreads(HostBlacklistsDataSourceFacade skds, AtomicInteger ocurrencesCount, int BLACK_LIST_ALARM_COUNT, AtomicInteger checkedListsCount, String ipaddress, LinkedList<Integer> blackListOcurrences, int servidorActual, int numeroAnalisis) {
		this.skds= skds;
